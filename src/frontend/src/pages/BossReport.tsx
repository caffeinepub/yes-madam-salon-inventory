...
export function BossReport() {
  ...
  const { data: usageRecords = [], refetch: refetchUsage } = useUsageRecords();
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mb-10" data-ocid="boss_report.stock_section">
          ...
          {sortedProducts.length === 0 ? (
            ...
            >
              <p className="text-white/30 text-sm">Koi product nahi mila.</p>
            </div>
          ) : (
            <div
              className="rounded-xl overflow-hidden"
          ...
          <div className="flex items-center gap-5 mt-3 px-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              />
              <span className="text-xs text-white/30">Kam (20% se neeche)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <div
                className="w-2 h-2 rounded-full"
